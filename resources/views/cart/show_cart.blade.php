...
<div class="row cart">
    ...
    <div class="col-lg-6 col-md-6" id="tfoot">
        <tfoot >
        <tr>
            <td colspan="5" class="text-right"><h5><strong>Tổng số lượng: {{Cart::count()}}</strong></h5></td>
        </tr>
        <tr>
        
            <td colspan="5" class="text-right"><h5><strong>Thành tiền: {{Cart::subtotal().' VNĐ'}} </strong></h5></td>
        </tr>
        <tr>
            <td colspan="5" class="text-right">
                ...
                <?php
                   ...
                   if($account_id !=NULL){
                    ?>
                    <a href="{{URL::to('/checkout/'.$account_id)}}">
